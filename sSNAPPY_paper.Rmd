...
In the following we'll inspect the 6 most highly ranked pathways and then for visualisation, create a categorical variable with the pathway status, rename the logFC column to reflect the true meaning of the value and transform the p-values for simpler visualisation

```{r}
sigPathway <- topTable(z_fits, number = 6) %>% 
  rownames_to_column("gs_name") %>% 
