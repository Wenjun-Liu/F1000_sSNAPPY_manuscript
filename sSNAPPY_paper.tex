...
Among the stress-related marker genes reported, five (\emph{FOS}, \emph{GADD45B}, \emph{IL6}, \emph{JUN}, and \emph{TNF}) were implicated in pathways that were considered to be significantly impacted by sSNAPPY.
...
\caption{Significantly perturbed KEGG pathways identified among post-chemotherapy samples using sSNAPPY, colored by (A) predicted direction of changes and (B) -log10(p-values). Only pathways with a FDR-adjusted p-value < 0.05 from moderated t-tests are shown.}\label{fig:Figure4}
\end{figure}
