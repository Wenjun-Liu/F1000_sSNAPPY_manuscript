...
\midrule
\cellcolor{gray!6}{TP53 regulates transcription of several additional cell death genes whose specific roles in p53-dependent apoptosis remain uncertain} & \cellcolor{gray!6}{0.96} & \cellcolor{gray!6}{1.7e-05} & \cellcolor{gray!6}{0.013} & \cellcolor{gray!6}{Activated}\\
IKK complex recruitment mediated by RIP1 & 0.87 & 3.0e-05 & 0.013 & Activated\\
\cellcolor{gray!6}{SUMOylation of DNA replication proteins} & \cellcolor{gray!6}{-0.86} & \cellcolor{gray!6}{4.4e-05} & \cellcolor{gray!6}{0.013} & \cellcolor{gray!6}{Inhibited}\\
SUMO E3 ligases SUMOylate target proteins & -0.83 & 4.7e-05 & 0.013 & Inhibited\\
\cellcolor{gray!6}{SUMOylation} & \cellcolor{gray!6}{-0.80} & \cellcolor{gray!6}{7.3e-05} & \cellcolor{gray!6}{0.016} & \cellcolor{gray!6}{Inhibited}\\
\addlinespace
TFAP2A acts as a transcriptional repressor during retinoic acid induced cell differentiation & 0.87 & 1.1e-04 & 0.017 & Activated\\
\cellcolor{gray!6}{Activation of ATR in response to replication stress} & \cellcolor{gray!6}{-0.84} & \cellcolor{gray!6}{1.3e-04} & \cellcolor{gray!6}{0.017} & \cellcolor{gray!6}{Inhibited}\\
Cell Cycle & -0.84 & 1.4e-04 & 0.017 & Inhibited\\
\cellcolor{gray!6}{RHO GTPases Activate Formins} & \cellcolor{gray!6}{-0.81} & \cellcolor{gray!6}{1.8e-04} & \cellcolor{gray!6}{0.017} & \cellcolor{gray!6}{Inhibited}\\
Cell Cycle, Mitotic & -0.81 & 1.9e-04 & 0.017 & Inhibited\\
\addlinespace
\cellcolor{gray!6}{G2/M DNA replication checkpoint} & \cellcolor{gray!6}{-0.85} & \cellcolor{gray!6}{2.0e-04} & \cellcolor{gray!6}{0.017} & \cellcolor{gray!6}{Inhibited}\\
Transcriptional regulation of white adipocyte differentiation & 0.73 & 2.0e-04 & 0.017 & Activated\\
\cellcolor{gray!6}{Circadian Clock} & \cellcolor{gray!6}{0.81} & \cellcolor{gray!6}{2.0e-04} & \cellcolor{gray!6}{0.017} & \cellcolor{gray!6}{Activated}\\
...
\NormalTok{top200 }\OtherTok{\textless{}{-}} \FunctionTok{rank}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\FunctionTok{abs}\NormalTok{(meanFC)) }\SpecialCharTok{\textless{}=} \DecValTok{200}
...
\NormalTok{        .[}\FunctionTok{rownames}\NormalTok{(.) }\SpecialCharTok{\%in\%} \FunctionTok{rownames}\NormalTok{(weightedFC}\SpecialCharTok{$}\NormalTok{weighted\_logFC),],}
    ...
    \AttributeTok{breaks =} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{0.001}\NormalTok{, }\FloatTok{0.001}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{), }
    ...
    \AttributeTok{cutree\_cols =} \DecValTok{3}\NormalTok{,}
...
\NormalTok{    dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(mapTo }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"CDCA8"}\NormalTok{, }\StringTok{"UBE2I"}\NormalTok{, }\StringTok{"BIRC5"}\NormalTok{, }\StringTok{"SUMO1"}\NormalTok{, }\StringTok{"SUMO2"}\NormalTok{, }\StringTok{"SUMO3"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
